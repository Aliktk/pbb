...
function person(n: string, r: string, d: string, extra?: ReactNode) {
  return (
    <div className="card" style={css('padding:0;overflow:hidden')}>
      <ImageSlot ratio="1/1" style="border-radius:0;border:0;border-bottom:1px solid var(--line)" placeholder="portrait" />
    ...
    <>
      ...
      <section className="blk" style={css('padding-top:0')}>
        <div className="wrap">
          ...
          <div className="g3">
            {person('Olus Yar', 'Olus Yar, PBB', 'Heads the organisation. Every branch, every account and every register answers upward to this office.', (
